...
public class MapIndex{
    ...
    public MapIndex GetNextValue(Direction direction){
        return direction switch{
            Direction.North => new(line - 1, column),
            Direction.East => new(line, column + 1),
            Direction.South => new(line + 1, column),
            Direction.West => new(line, column - 1),
